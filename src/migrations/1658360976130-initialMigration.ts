...
export class initialMigration1658360976130 implements MigrationInterface {
    name = 'initialMigration1658360976130'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying NOT NULL, "number" character varying NOT NULL, "cep" character varying NOT NULL, "complement" character varying, "town" character varying NOT NULL, "state" character varying NOT NULL, "status" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "avaliations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "wheight" integer NOT NULL, "height" integer NOT NULL, "neck" character varying NOT NULL, "waist" integer NOT NULL, "bust" integer NOT NULL, "hip" integer NOT NULL, "arm_right" integer NOT NULL, "arm_left" integer NOT NULL, "leg_right" integer NOT NULL, "leg_left" integer NOT NULL, "cardio_freq" integer NOT NULL, "circumference" integer NOT NULL, "diameter" integer NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "status" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_5b5462ad51d5bad006c10689b6d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "journals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "exercise" character varying NOT NULL, "time" character varying NOT NULL, "repetitions" integer NOT NULL, "status" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_157a30136385dd81cdd19111380" PRIMARY KEY ("id"))`);
